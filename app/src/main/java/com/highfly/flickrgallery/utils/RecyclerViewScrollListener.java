...
/**
 * Created by - Nathan Esquenazi - https://gist.github.com/nesquena
 * Edited by - Ngoc Nguyen
 */
public abstract class RecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    // The minimum amount of items to have below your current scroll position
    // before loading more.
    private final static String TAG = "RecyclerViewScroll";
    private final static int THRESHOLD = 5;
    private final static int START_INDEX = 1;

    private int visibleThreshold;
    // The current offset index of data you have loaded
    private int currentPage = START_INDEX;
    ...
    public void onScrolled(RecyclerView view, int dx, int dy) {
        ...
        if (!loading && (lastVisibleItemPosition + visibleThreshold) > totalItemCount) {
            ...
            loading = true;
            Log.i(TAG, "Current Page, Last Visible Item Position, Total Item Count: "
                    + currentPage + ", " + lastVisibleItemPosition + ", " + totalItemCount);
        }
    }
